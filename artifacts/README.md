...
- `qwen35_4b.zip`: independent Qwen3.5-4B test comparison (vLLM dual-GPU inference).
...
- `qwen35_4b_qlora.zip`: Qwen3.5-4B complete post-training release (vLLM dual-GPU inference).
